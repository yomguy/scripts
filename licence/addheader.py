...
python ~/dev/tools/licence/addheader.py ~/dev/tools/licence/copyright_header-py.txt app/ '.*\.py$' '^((?!migrations|__pycache__).)*$'
python ~/dev/tools/licence/addheader.py ~/dev/tools/licence/copyright_header-scss.txt app/ '.*\.scss$'
"""
import os
import re
import sys
